...
// Add to destructuring in useDataStore wrapper
// actually I'll just leave it out if it doesn't break. 
// Wait, the hook is useDataStore = create<...>()
...
code = code.replace(
  ...
  "const data = await idbGet('taka_data');\n        const dailySalesProfits = await idbGet('dailySalesProfits');\n        if (dailySalesProfits) set({ dailySalesProfits });"
);
